"use strict";Vue.component("chat",{template:`<div id="content-wrap" style="padding:10px;">
                        ...
                        <div class="panel-collapse collapse in chatparent" id="collapseOne">
                            <div class="chatlay">
                                <div class="content">
                                    ...
                                    <input id="txtusername" type="text" placeholder="What's your name?"></input><br />
                                    <button @click.prevent="letsstart" class="btn btn-info btn-sm" id="btnchatstart">Let's start...</button>
                                </div>
                            </div>
                ...
                </div>`,props:["accessKey"],data:function(){return{connecition:null,access:this.accessKey,licensed:!1,items:[]}},created:function(){this.licensed=!0;console.log("Component is created.Please wait for connection.");console.log("Connecting...");this.connection=(new signalR.HubConnectionBuilder).withUrl("/Ntfctn?key=ARDA"+this.accessKey).configureLogging(signalR.LogLevel.Information).build();this.connection.serverTimeoutInMilliseconds=3e5},mounted:function(){var n=this;if(this.licensed){n.connection.onclose(function(){console.log("Connecition is closed")});n.connection.on("GiveName",function(n){$("#txtuser").val(n)});n.connection.on("SayHello",function(n){$("#onlinehost").html(n)});n.connection.on("ReceiveMessage",function(n,t){try{component.$refs.box?component.$refs.box.addMessage(t):console.error("Invalid ref value for component. Please keep 'ref=\"box\"' attribute as default.")}catch(i){console.log(i.message)}})}},methods:{letsstart:function(){var n=this;n.connection.start().then(()=>{console.log("Component is connected");$(".chatlay").hide();var n=$("#txtusername").val();$("#txtuser").val(n)}).catch(n=>console.error(n))},sendMessage:function(){var t,i;try{var r=this,u=$("#txtuser").val(),n=$("#txtmessage").val();$("#txtmessage").val("");t=$("chatcontent");t.scrollTop+=1e3;i={username:u,message:n};n&&r.connection.invoke("SendPrivateMessage",i).catch(n=>console.error(n))}catch(f){console.log(f.message)}},addMessage:function(n){var t=this;t.items.push(n);console.log("Component's addMessage is fired.")}}});