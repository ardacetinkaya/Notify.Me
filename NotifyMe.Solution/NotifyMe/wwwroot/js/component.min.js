"use strict";Vue.component("chat",{template:`<div id="content-wrap" class="boxeffect">
                ...
                </div>`,props:["accessKey","warning"],data:function(){return{connecition:null,access:this.accessKey,licensed:!1,items:[]}},created:function(){this.licensed=!0;console.log("Component is created.Please wait for connection.");console.log("Connecting...");this.connection=(new signalR.HubConnectionBuilder).withUrl("/Ntfctn?key="+this.accessKey).configureLogging(signalR.LogLevel.Information).build();this.connection.serverTimeoutInMilliseconds=3e5},mounted:function(){var n=this;if(this.licensed){n.connection.onclose(function(){$(".chatlay").show();console.log("Connecition is closed")});n.connection.on("GiveName",function(n){$("#txtuser").val(n);$(".chatlay").hide()});n.connection.on("SayHello",function(n){$("#onlinehost").html(n)});n.connection.on("ReceiveMessage",function(n,t,i){try{component.$refs.box?component.$refs.box.addMessage(i):console.error("Invalid ref value for component. Please keep 'ref=\"box\"' attribute as default.")}catch(r){console.log(r.message)}})}},methods:{letsstart:function(){var n=this;n.connection.start().then(()=>{console.log("Component is connected");var n=$("#txtusername").val();$("#txtfriendlyname").val(n)}).catch(n=>{console.log(n),$(".chatlay").show()})},sendMessage:function(){var t,i;try{var r=this,u=$("#txtuser").val(),f=$("#txtfriendlyname").val(),n=$("#txtmessage").val();$("#txtmessage").val("");t=$("chatcontent");t.scrollTop+=1e3;i={username:u,friendlyusername:f,message:n};n&&r.connection.invoke("SendPrivateMessage",i).catch(n=>console.error(n))}catch(e){console.log(e.message)}},addMessage:function(n){var t=this;t.items.push(n)}}});